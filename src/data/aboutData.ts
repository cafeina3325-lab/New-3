/**
 * About 페이지 전용 정적 텍스트 데이터 
 * 
 * 브랜드의 핵심 철학 및 비스포크 타투 설계 시 원칙 등의
 * 랜딩 페이지 내러티브 복사본(Copy) 데이터를 관리합니다.
 */
...
// 도안 맞춤화(Bespoke Design) 시 아티스트가 중점적으로 고려하는 가치 항목 배열
export const CUSTOMIZE_POINTS = [
