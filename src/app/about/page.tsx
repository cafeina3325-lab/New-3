...
function InfoOverlay({ onClose }: { onClose: () => void }) {
    return (
        ...
        >
            <div
                className="glass-premium rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.5)] w-full max-w-2xl max-h-[90vh] overflow-y-auto relative border border-white/20"
            ...
            >
                ...
                <div className="p-8 text-white">
                    <h2 className="text-2xl font-bold mb-6 text-white border-b border-white/20 pb-2">Aftercare Checklist</h2>

                    <div className="space-y-6">
                        <div>
                            <h3 className="text-lg font-bold text-gray-100 mb-2">A. Healing Overview</h3>
                        ...
                        <div>
                            <h3 className="text-lg font-bold text-gray-100 mb-2">B. Do / Don’t</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="bg-green-900/40 border border-green-500/30 p-4 rounded">
                                ...
                                <div className="bg-red-900/40 border border-red-500/30 p-4 rounded">
                        ...
                        <div>
                            <h3 className="text-lg font-bold text-gray-100 mb-2">C. Why results vary</h3>
                        ...
                        <div>
                            <h3 className="text-lg font-bold text-gray-100 mb-2">D. Support & Touch-up</h3>
                            <p className="text-gray-300 text-sm">
...
export default function AboutPage() {
    ...
    return (
        <main className="pt-[120px] min-h-screen bg-[var(--color-green-900)] text-[var(--color-off-white)] selection:bg-[var(--color-gold-500)] selection:text-black">

            {/* 1. Our Legacy Section */}
            <section className="container mx-auto px-6 py-20">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <h1 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight text-[var(--color-off-white)]">Our Legacy</h1>
                    <div className="text-lg md:text-xl text-white/60 space-y-2 leading-relaxed font-light">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                    {[
                        ...
                        <div key={idx} className="relative group h-[280px] flex items-center justify-center">
                            ...
                            <div
                                className="absolute inset-0 glass-premium transition-all duration-300 group-hover:scale-105"
            ...
            <section className="py-20">
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
                        {/* A. What we customize */}
                        <div className="glass-premium p-8 rounded-lg shadow-sm">
                            <h3 className="text-xl font-bold mb-6 border-b border-white/20 pb-4 text-white">A. What we customize</h3>
                        ...
                        <div className="space-y-6">
                            {/* B. Reference Policy */}
                            <div className="glass-premium p-6 rounded-lg shadow-sm border-l-4 border-white">
                            ...
                            {/* C. Design Flow */}
                            <div className="glass-premium p-6 rounded-lg shadow-sm">
                                <h3 className="text-lg font-bold mb-4 text-white">C. Design Approval Flow</h3>
                                <div className="flex flex-wrap items-center gap-2 text-sm text-gray-400">
                                    <span className="bg-white/10 px-3 py-1 rounded">상담/방향 확정</span>
                                    <span>→</span>
                                    <span className="bg-white/10 px-3 py-1 rounded">1차 스케치</span>
                                    <span>→</span>
                                    <span className="bg-white/10 px-3 py-1 rounded">수정 안내</span>
                                    <span>→</span>
                                    <span className="bg-white text-black font-bold px-3 py-1 rounded">최종 승인</span>
                                </div>
                            </div>
            ...
            <section className="container mx-auto px-6 py-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
                    <div className="p-6 glass-premium rounded-lg hover:border-white transition-colors">
                        <h3 className="text-xl font-bold mb-4 text-red-400">Booking</h3>
                        <p className="text-sm text-gray-300 font-bold mb-2">상담 예약제</p>
                    ...
                    <div className="p-6 glass-premium rounded-lg hover:border-white transition-colors">
                        ...
                        <p className="text-sm text-gray-300 font-bold mb-2">예약금 제도</p>
                        <p className="text-xs text-gray-500">
                            일정 확보 및 노쇼 방지 목적. 단순 변심/무단 불참 시 환불 불가.
                        </p>
                    </div>
                    <div className="p-6 glass-premium rounded-lg hover:border-white transition-colors">
                        <h3 className="text-xl font-bold mb-4 text-white">Policy</h3>
                        <p className="text-sm text-gray-300 font-bold mb-2">변경/취소</p>
                        <p className="text-xs text-gray-500">
                    ...
                    <div className="p-6 glass-premium rounded-lg hover:border-white transition-colors">
                        ...
                        <p className="text-sm text-gray-300 font-bold mb-2">시술 조건</p>
                        <p className="text-xs text-gray-500">
            ...
            <section className="glass-premium border-t border-white/10 text-white py-16">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <button
                        ...
                        className="px-8 py-3 border border-white rounded-full hover:bg-white hover:text-black transition-all"
                    >
                        관리 체크리스트 확인하기
                    </button>
                </div>
