...
export default function SectionE() {
    ...
    return (
        <section className="py-12 sm:py-16 md:py-20 lg:py-28 bg-[#0A0706] w-full overflow-hidden border-t border-white/5">
            ...
            {/* 리뷰 작성 버튼 */}
            <div className="container mx-auto px-4 sm:px-6 flex justify-end mt-2 md:mt-4">
                <button
                    onClick={() => setIsReviewOpen(true)}
                    className="px-5 py-2.5 sm:px-6 sm:py-3 bg-white/10 hover:bg-white/20 border border-white/10 hover:border-white/30 text-[#F3EBE1] text-sm md:text-base font-bold tracking-wide rounded-lg transition-all backdrop-blur-sm flex items-center gap-1.5 sm:gap-2"
                >
